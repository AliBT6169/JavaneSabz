<svg xmlns="http://www.w3.org/1999/html">
    ...
    <svg id="strawberry" viewBox="0 0 32 32">
        <g fill="currentColor">
            <path
                d="M9.62 13.24c-.51 0-.93.42-.93.93v.93c0 .51.42.93.93.93s.93-.42.93-.93v-.93c0-.52-.42-.93-.93-.93m2.25 5.83c0-.51.42-.93.93-.93c.52 0 .93.42.93.93V20c0 .51-.42.93-.93.93s-.93-.42-.93-.93zm7.3-.93c-.51 0-.93.42-.93.93V20c0 .51.42.93.93.93s.93-.42.93-.93v-.93c0-.51-.41-.93-.93-.93m-4.11-3.97c0-.51.42-.93.93-.93s.93.41.93.93v.93c0 .51-.42.93-.93.93s-.93-.42-.93-.93zm0 9.45c0-.51.42-.93.93-.93s.93.42.93.93v.93c0 .51-.42.93-.93.93s-.93-.42-.93-.93zm6.38-9.45c0-.51.42-.93.93-.93s.93.41.93.93v.93c0 .51-.42.93-.93.93s-.93-.42-.93-.93z"/>
            <path
                d="M16.98 3a1 1 0 1 0-2 0v2h-3.4a6.446 6.446 0 0 0-6.44 6.44v1h.639c-1.412 3.576-1 7.882 1.98 11.261l5.272 5.972a3.94 3.94 0 0 0 5.897 0l5.271-5.972c2.98-3.379 3.392-7.685 1.98-11.261h.63v-1A6.44 6.44 0 0 0 20.37 5h-3.39zm-9.014 9.44h3.713a6.42 6.42 0 0 0 4.297-1.643a6.42 6.42 0 0 0 4.293 1.643h3.723c1.522 3.051 1.35 6.94-1.293 9.938l-5.268 5.969a1.94 1.94 0 0 1-2.903 0l-5.27-5.969c-2.642-2.998-2.814-6.887-1.292-9.938"/>
        </g>
    </svg>
    ...
    <symbol id="tell" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
    ...
    <symbol id="indexBrands" viewBox="0 0 24 24">
    ...
    <symbol id="equipments" viewBox="0 0 24 24">
    ...
    <symbol id="courses" viewBox="0 0 48 48">
        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3">
            <path d="M25 29.999c7.99-.017 13.372-.233 16.512-.414c2.076-.12 3.752-1.591 3.992-3.656C45.757 23.76 46 20.5 46 16s-.243-7.76-.496-9.93c-.24-2.064-1.916-3.535-3.991-3.655C38.243 2.226 32.543 2 24 2q-1.028 0-2 .004M12.5 34v11M6 9.5a6.5 6.5 0 1 0 13 0a6.5 6.5 0 0 0-13 0" />
            <path d="M28.539 16.338c.625.036 1.192.379 1.326.99c.144.656.226 1.675-.035 3.103c-.143.781-.809 1.342-1.596 1.45L20 23l-1.8 19.32c-.12 1.284-1.05 2.343-2.33 2.49a29 29 0 0 1-3.303.19c-1.263 0-2.403-.084-3.318-.185c-1.338-.149-2.3-1.275-2.373-2.62l-.618-11.317a67 67 0 0 1-2.578-.183a1.82 1.82 0 0 1-1.654-1.889c.117-3.77.593-7.216.989-9.515c.298-1.728 1.762-2.977 3.514-3.062c6.958-.338 14.84-.302 22.01.11Z" />
        </g>
    </symbol>
    ...
    <symbol id="picture" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="4">
            <path d="M39 6H9a3 3 0 0 0-3 3v30a3 3 0 0 0 3 3h30a3 3 0 0 0 3-3V9a3 3 0 0 0-3-3" />
            <path d="M18 23a5 5 0 1 0 0-10a5 5 0 0 0 0 10m9.79 3.22a2 2 0 0 1 3.243.053l8.775 12.583c.924 1.326-.025 3.144-1.64 3.144H16z" />
        </g>
    </symbol>
</svg>
