...
<template>
    <IndexLyout>
        <div data-aos="fade-up" v-if="data.allProducts.data.length>0" class="w-full mx-auto !transform-none">
        ...
        <div class="w-full overflow-x-scroll" v-if="data.products.data.length>0">
