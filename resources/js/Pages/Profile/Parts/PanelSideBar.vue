...
<template class="select-none ">
    <div class="invisible SidebarCloser overflow-scroll shadow no-scroll opacity-0 grid fixed z-10 duration-300 top-20 w-20 h-[calc(100vh-5.4rem)] rounded-[40px] bg-defaultColor5
