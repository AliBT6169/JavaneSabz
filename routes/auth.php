...
Route::middleware('guest')->group(function () {
    ...
    Route::get('adminLogin', [AdminLogin::class, 'create'])
        ->name('adminLogin');
    Route::post('adminLoginStore', [AdminLogin::class, 'store'])
        ->name('adminLoginStore');
    ...
    Route::controller(SMSController::class)->group(function () {
        Route::post('get-auth-sms', 'sendAuthSMS')->name('sendLoginSMSCode');
        Route::post('send-sms-code', 'codeValidation')->name('sendVerificationCode');
